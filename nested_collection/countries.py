...
# create a function get_country_by_name(country_name)

# return data of country with name = country_name
...
# print(get_country_by_name("china"))


# create a fiunction get_country_capital(country_name)
...
print(get_country_capital("Afghanistan"))

# 15 diiferent scnro questions

#P function for fetching currency symbol by country name
...
def get_currency_symbol(country_name):
    ...
    if "currencies" in country_data:
      ...
      all_currencies = country_data.get("currencies")
...
def get_all_countries_border_count():
   
   border_count ={c.get("name") :len(c.get("borders",[])) for c in countries}

   print(border_count)



# get_all_countries_border_count()
# get_currency_symbol("")


def get_country_with_english_lang():
  ...
  for c in countries:
     ...
     if "languages" in c:
      ...
      for lang in c.get("languages"):
         ...
         if lang.get("name").lower() == "english":
...
longest_cntry=max(countries,key=lambda dictionary:dictionary.get("area",0))

# print(longest_cntry.get("name"))


most_populated_country = max(countries,key=lambda country:country.get("population",0))
